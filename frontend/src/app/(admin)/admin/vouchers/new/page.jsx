      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        <div>
          ...
          <input
            type="text"
            name="code"
            className={`w-full border rounded-lg px-4 py-2 uppercase focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 transition ${
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="number"
              name="discount_value"
              className={`w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 transition ${
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 transition ${
                errors.min_order_value ? 'border-red-500' : 'border-gray-300'
              }`}
